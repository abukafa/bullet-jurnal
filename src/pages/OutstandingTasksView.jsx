...
export default function OutstandingTasksView() {
  ...
  const outstandingTasks = useMemo(() => {
    ...
    return allBullets
      .filter(b => b.status === 'incomplete' && (b.type === 'task' || b.type === 'event') && !(typeof b.pageId === 'string' && b.pageId.startsWith('col_')))
      .sort((a, b) => {
        // Sort by date first
    ...
    <div className="outstanding-tasks-page">
      ...
      <div className="bullets-container outstanding-list">
        {outstandingTasks?.length === 0 && (
          <p className="empty-state" style={{ marginTop: '2rem', textAlign: 'center', color: 'var(--text-muted)' }}>
